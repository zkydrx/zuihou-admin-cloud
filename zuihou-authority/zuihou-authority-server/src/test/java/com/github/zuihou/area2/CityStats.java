...
public class CityStats
{
    ...
    public static void parseCity(String url, Area provinceArea)
    {
        ...
        for (Element tr : trs)
        {
            ...
            Area cityArea = Area.builder()
                                ...
                                .fullName(provinceArea.getFullName() + cityName)
                                .build();
    ...
    public static void parseCounty(String url, Area cityArea)
    {
        ...
        for (Element tr : trs)
        {
            ...
            Area countyArea = Area.builder()
                                  .label(countyName)
                                  .code(countyCode)
                                  .source(url)
                                  .sortValue(sort++)
                                  .level(new RemoteData<>("COUNTY"))
                                  .fullName(cityArea.getFullName() + countyName)
                                  .build();
    ...
    public static void parseTowntr(String url, Area countyArea)
    {
        ...
        for (Element tr : trs)
        {
            ...
            Area towntrArea = Area.builder()
                                  ...
                                  .fullName(countyArea.getFullName() + towntrName)
                                  .build();

            StaticLog.info("		乡镇级数据:  {}  ", towntrArea);

            parseVillagetr(COMMON_URL + href.subSequence(2, 5).toString() + "/" + href.substring(5, 7) + "/" + href, countyArea);
    ...
    public static void parseVillagetr(String url, Area countyArea)
    {
        ...
        for (Element tr : trs)
        {
            ...
            Area villagetrArea = Area.builder()
                                     .code(villagetrCode)
                                     .label(villagetrName)
                                     .source(url)
                                     .sortValue(sort++)
                                     .level(new RemoteData<>("VILLAGETR"))
                                     .fullName(countyArea.getFullName() + villagetrName)
                                     .build();
