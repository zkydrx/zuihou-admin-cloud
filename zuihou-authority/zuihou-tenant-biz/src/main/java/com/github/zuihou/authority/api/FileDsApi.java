...
import com.github.zuihou.authority.api.fallback.FileDsApiFallback;
 ...
 */
@FeignClient(name = "${zuihou.feign.file-server:zuihou-file-server}", path = "/ds", fallback = FileDsApiFallback.class)
