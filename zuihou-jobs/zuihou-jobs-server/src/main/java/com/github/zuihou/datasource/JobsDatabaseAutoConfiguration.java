...
@Configuration
@Slf4j
@MapperScan(basePackages = {"com.xxl.job.admin.dao", "com.github.zuihou",}, annotationClass = Repository.class, sqlSessionFactoryRef =
        JobsDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
