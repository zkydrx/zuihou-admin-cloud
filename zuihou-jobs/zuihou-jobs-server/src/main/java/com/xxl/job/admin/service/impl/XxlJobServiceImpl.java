...
public class XxlJobServiceImpl implements XxlJobService
{
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo)
    {
        ...
        else
        {
            ...
            //表单校验
            String msg = validate(jobInfo.getIntervalSeconds(), jobInfo.getRepeatCount(), jobInfo.getStartExecuteTime(), jobInfo.getEndExecuteTime());
    ...
    public ReturnT<String> start(Integer id)
    {
        ...
        {
            //表单校验
            String msg = validate(xxlJobInfo.getIntervalSeconds(), xxlJobInfo.getRepeatCount(), xxlJobInfo.getStartExecuteTime(), xxlJobInfo.getEndExecuteTime());
            if (!StringUtils.isEmpty(msg))
            {
                return new ReturnT<String>(ReturnT.FAIL_CODE, msg);
            }
        ...
        try
        {
            ...
            else
            {
                ...
                ret = XxlJobDynamicScheduler.addJob(name,
                                                    group,
                                                    xxlJobInfo.getStartExecuteTime(),
                                                    xxlJobInfo.getEndExecuteTime(),
                                                    xxlJobInfo.getIntervalSeconds(),
                                                    xxlJobInfo.getRepeatCount());
            }
