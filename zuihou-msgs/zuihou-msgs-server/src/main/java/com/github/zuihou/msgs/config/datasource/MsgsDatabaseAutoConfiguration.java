...
@Configuration
@Slf4j
@MapperScan(basePackages = {"com.github.zuihou",}, annotationClass = Repository.class, sqlSessionFactoryRef = MsgsDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
