...
@Configuration
@Slf4j
@MapperScan(basePackages = {"com.github.zuihou"}, annotationClass = Repository.class, sqlSessionFactoryRef = DemoDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
