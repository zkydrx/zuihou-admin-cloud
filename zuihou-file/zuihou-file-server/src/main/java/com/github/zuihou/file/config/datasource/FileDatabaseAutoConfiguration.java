...
@Configuration
@Slf4j
@MapperScan(basePackages = {"com.github.zuihou",}, annotationClass = Repository.class, sqlSessionFactoryRef = FileDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
